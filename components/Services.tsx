    ...
    <section id="services" className="relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16 md:py-20">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-12">
            <div>
                 <p className="text-sm font-semibold tracking-wider text-[#FFD700] uppercase">
                    Our Capabilities
                 </p>
            ...
            <a href="#contact" className="hidden md:inline-flex items-center justify-center gap-2 text-base font-medium text-gray-200 hover:text-white hover:bg-white/10 ring-1 ring-white/20 rounded-lg px-4 py-2.5 transition-colors mt-6 md:mt-0 flex-shrink-0">
              Start a project
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service) => (
            <div key={service.title} className="bg-white/5 p-6 rounded-xl border border-white/10 hover:border-[#FFD700] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_0_20px_rgba(255,215,0,0.2)]">
